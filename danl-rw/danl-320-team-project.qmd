...
2. **Variables**
	-	List and define each field/column you will use (e.g. Date, Close, Sector, Total_ESG, …).
3. **Cleaning & Processing**
	-	Handling of missing values or outliers
	-	Any transformations (normalization, encoding, filtering)
4. **Descriptive Summary**
	-	Key summary statistics (mean, median, sd, counts)
	-	At least two visualizations (histogram, boxplot, time series plot, etc.)
5. **Visualization**
...
-	**Length**:
	-	Total (excluding References): ≈ 3500–6000 words
