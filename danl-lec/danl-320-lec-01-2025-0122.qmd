...
- Choe, B.H. "Estimating the Value of Statistical Life through Big Data" (with Newbold, S. and James, A.)
...
- Follow steps described in [Classwork 1](https://bcdanl.github.io/320/danl-cw/danl-310-cw-01.html).
...
- Let's do [Classwork 2](https://bcdanl.github.io/320/danl-cw/danl-310-cw-02.html).
...
- The following syntax is part of YAML metadata in `danl-310-quarto-r.qmd`.
  - In YAML, indentation really matters!
  - **tab** (or four spaces) defines a level in YAML.
...
- Let's do [Classwork 3](https://bcdanl.github.io/320/danl-cw/danl-310-cw-03.html).
