...
$$
\hat{\epsilon_{1st}} = \log(\text{price}) - \widehat{\log(\text{price})}
$$
...
$$
\log(\text{sales}) = \beta_0 + \beta_1\hat{\epsilon_{1st}}  + \epsilon_{2nd}
$$
...
$$
\widehat{\epsilon_{short}} = \beta_{2}X_2 + \epsilon_{long}
$$
