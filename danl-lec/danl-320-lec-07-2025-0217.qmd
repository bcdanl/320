...
- As aggregation became analysis, Big Data got closer to stats + ML.
  - Scaleability of algorithms is essential.
  
- We will do ML analysis to:
  - Infer patterns from big data.
...
- Principal Component Analysis: dimention reduction
