...
-  The goals of linear regression here are to: 
  ...
  1. Find the relationship between `gross_square_feet` and `sale_price` by estimating a true value of `b1`.
  - The estimated value of `b1` is denoted by $\hat{\texttt{b1}}$.
    
  2. Make a prediction on `sale_price[i]` for new property `i`
