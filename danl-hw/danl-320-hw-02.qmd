...
|---------------------|----------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `priceper1`           | Numeric        | The unit price for one product serving (in dollars).                                                                                             | Continuous numeric value.                                                                                                                                                                      |
| `flavor_descr`        | Categorical    | Description of the ice cream flavor.                                                                                                                      | Values include names like “CAKE BATTER,” “VAN CARAMEL FUDGE,” “W-N-C-P-C,” “AMERICONE DREAM”. These represent different flavor variants offered.                                           |
| `size1_descr`         | Numeric/Label  | The description of the package or serving size (in fluid ounces or a related measure).                                                                     | For example, “16.0 MLOZ” indicates a 16 fluid ounce serving size. This column is essentially constant across observations in this dataset.                                                     |
| `household_id`        | Categorical/ID | Unique identifier for each household purchasing product(s).                                                                                               | Alphanumeric or numeric IDs; these are identifiers and not ordered categories.                                                                                                                |
| `household_income`    | Categorical/Numeric    | The household income bracket (in dollars).                                                                                                        | The number (e.g., 60,000) corresponds to predefined income categories. (for instance, “60,000” represents a particular income range from $60,000 to $70,000).  |
...
| `region`              | Categorical    | Geographic region where the household is located.                                                                                                         | Categories include “Central”, “West”, “South”, etc. Each label represents a defined regional area.                                                                                             |
...
| `race`                | Categorical    | Race of the household head or primary respondent.                                                                                                         | For example, “white” is shown. Likely includes other categories such as Black, Asian, etc. The dataset appears to use text labels for race.                                                     |
