...
- Note that fit one model at a time. 
...
## Question 2
-  Evaluate the relationship between the percentage change in the price of beer and the percentage change in the volume of beer purchases for each brand, using models with extensive demographic controls.
  - Analyze how sensitive the price change is to volume changes.
